# Generated by Django 5.0.7 on 2025-01-26 14:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backend', '0010_order_discount_coupon_applied'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.paymentorder')),
            ],
            options={
