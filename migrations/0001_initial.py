# Generated by Django 5.0.7 on 2024-11-10 04:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_order_price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('product_id', models.CharField(blank=True, help_text='Optional product identifier', max_length=100, null=True)),
                ('image_url', models.TextField(blank=True, null=True)),
                ('image_type', models.CharField(choices=[('product', 'Product Image'), ('carousel', 'Carousel Image'), ('other', 'Other Image')], default='product', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], default='PROCESSING', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_variation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.productvariation')),
            ],
        ),
        migrations.AddField(
            model_name='order',
